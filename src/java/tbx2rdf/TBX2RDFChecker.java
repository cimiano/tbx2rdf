...
public class TBX2RDFChecker {
    ...
    /**
     * Determines whether the given TBX file is valid or not, according to the tbx validator
     * More info here: http://www.tbxconvert.gevterm.net/tbx_checker_explanation.html
