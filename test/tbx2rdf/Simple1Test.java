...
public class Simple1Test {
   ...
   Boolean found;
    ...
    for(Statement stat : stats) {
        ...
        {
        	if (stmt.getObject().asLiteral().getString().equals("es")) found = true;
        }
    }
    ...
    for(Statement stat : stats) {
        ...
        for (Statement stmt: stats2)
        {
        	if (stmt.getObject().asLiteral().getString().equals("en")) found = true;
        }
    }
    ...
    for(Statement stat : stats) {
        ...
        for (Statement stmt: stats2)
        {
        	if (stmt.getObject().asLiteral().getString().equals("de")) found = true;
        }
    }
    ...
    public void checkLCanonicalForms() throws Exception {
        ...
        for(Statement stat : stats) {
            ...
            for (Statement stmt: stats2)
            {
            	if (stmt.getObject().asLiteral().getString().equals("Zuständigkeit der Mitgliedstaaten")) found = true;
            }
        }
        ...
        for(Statement stat : stats) {
            ...
            for (Statement stmt: stats2)
            {
            	if (stmt.getObject().asLiteral().getString().equals("competence of the Member States")) found = true;
            }
        }
        ...
        for(Statement stat : stats) {
            ...
            for (Statement stmt: stats2)
            {
            	if (stmt.getObject().asLiteral().getString().equals("competencias de los Estados miembros")) found = true;
            }
        }
